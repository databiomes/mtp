...
class TestProtocol:
    ...
    def test_protocol_initialization_encrypted(self):
        ...
        protocol = ProtocolV2("test_protocol", inputs=3, encrypt=True)
    ...
    def test_protocol_initialization_unencrypted(self):
        ...
        protocol = ProtocolV2("test_protocol", inputs=3, encrypt=False)
    ...
    def test_protocol_initialization_invalid_instruction_context_snippets(self):
        ...
        with pytest.raises(ValueError, match="minimum of 2 inputs"):
            ProtocolV2("test_protocol", inputs=1)

        with pytest.raises(ValueError, match="minimum of 2 inputs"):
            ProtocolV2("test_protocol", inputs=0)
    ...
    def test_protocol_initialization_valid_instruction_context_snippets(self):
        ...
        ProtocolV2("test_protocol", inputs=2)
        ProtocolV2("test_protocol", inputs=3)
        ProtocolV2("test_protocol", inputs=10)
    ...
    def test_protocol_various_instruction_context_snippets(self, instruction_context_snippets):
        ...
        protocol = ProtocolV2("test_protocol", inputs=instruction_context_snippets)
    ...
    def test_protocol_encryption_settings(self, encrypt):
        ...
        protocol = ProtocolV2("test_protocol", inputs=3, encrypt=encrypt)
    ...
    def test_protocol_name_variations(self):
        ...
        for name in names:
            protocol = ProtocolV2(name, inputs=3)
            assert protocol.name == name

    def test_protocol_from_json_round_trip(self, basic_simple_protocol: ProtocolV2):
    ...
    def test_protocol_from_json_missing_required_field(self, basic_simple_protocol: ProtocolV2):
        ...
        with pytest.raises(ProtocolError, match="Missing required field 'name'"):
            ProtocolV2.from_json(protocol_json)

    def test_protocol_from_json_generative_model_type(self, basic_simple_protocol: ProtocolV2):
    ...
    def test_protocol_from_json_multi_classifier_round_trip(self):
        ...
        protocol: ProtocolV2 = ProtocolV2("multi_classifier_round_trip", inputs=1, encrypt=False)
        for i in range(10):
